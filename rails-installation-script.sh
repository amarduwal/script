...
# Run this command to execute this file from local
...
rvm --version | sed '/^.*$/N;s/\n//g' | cut -c 1-11
echo -n "Should be ruby 2.6.0:                "
ruby -v | cut -d " " -f 2
echo -n "Should be Rails 5.2.1 or higher:         "
rails -v
echo -e "\n- - - - - -\n"
...
and we will help you do the installation the manual way.

Congrats!

Make sure that all works well by running the application generator command:
    $ rails new numbernine
